...
function renderRecibo()
{
    ...
    const {area, nombre, cuil, ingreso, mes, cantFaltas, cantFaltasSabado, cantFeriados, diasLicencia, diasLicenciaSab, horasTrabajo, horasCincuenta, horasCien, porcentajePresentismo, categoria, codigo, senioriti, salarioConvenio, afiliacion} = objetoUsuario; 
    ...
    var docDefinition = {
        watermark: { text: 'E.E.S.T N°4', color: 'darkgrey', opacity: 0.1, bold: true, italics: false},
        content: [
            { 
                alignment: 'center',
            ...
            },
            {
                ...
                layout: {
                    fillColor: function (rowIndex, node, columnIndex) {
                        return (rowIndex === 0 || rowIndex > 0) ? '#ffc95c' : null;
                    }
                },
                table: {
                    widths: ['100%'],
